...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-center rounded-lg bg-surface-200 p-1 text-text-secondary border border-border',
      className
    )}
    {...props}
  />
    ...
    return (
      <button
        ...
        className={cn(
          ...
          isSelected
            ? 'bg-surface-300 text-text-main shadow-sm font-semibold border border-border/60'
            : 'hover:text-text-main hover:bg-surface-100/50',
          className
        )}
